...
export const FlagIcon: FC<FlagIconProps> = ({ className, fillClassName, light }) => (
    <>
            ...
            <g transform="matrix(1.354099988937378, 0, 0, 1.7755999565124512, 631.8524780273436, 500.0080871582031)" id="924093">
                <g transform="matrix(1, 0, 0, 1, -150.254807, 0)">
                    <g transform="matrix(1 0 0 1 -102.803 199.684)" id="flat_x2C__basic_x2C__home_x2C__flag__x2C_">
                        <path className={cn('pole', { light })} transform="translate(-153.197, -455.684)" d="M 39.421 490.596 h 227.552 v -18.047 c 0 -28.242 -23.516 -51.777 -51.791 -51.777 H 91.22 c -28.22 0 -51.799 23.535 -51.799 51.777 V 490.596 z" strokeLinecap="round" />
                    </g>
                    <g transform="matrix(1 0 0 1 -102.783 -34.912)" id="flat_x2C__basic_x2C__home_x2C__flag__x2C_">
                        <polygon className={cn('pole', { light })} points="-19.607,199.683 19.607,199.683 19.607,41.967 19.607,-170.655 19.607,-199.683 -19.607,-199.683" />
                    </g>
